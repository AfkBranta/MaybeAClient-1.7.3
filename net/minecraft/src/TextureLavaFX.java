    ...
    public void onTick() {
        ...
        while (var1 < 16) {
            ...
            while (var2 < 16) {
                ...
                this.field_1146_h[var1 + var2 * 16] = var3 / 10.0f + (this.field_1145_i[(var1 + 0 & 0xF) + (var2 + 0 & 0xF) * 16] + this.field_1145_i[(var1 + 1 & 0xF) + (var2 + 0 & 0xF) * 16] + this.field_1145_i[(var1 + 1 & 0xF) + (var2 + 1 & 0xF) * 16] + this.field_1145_i[(var1 + 0 & 0xF) + (var2 + 1 & 0xF) * 16]) / 4.0f * 0.8f;
                float[] var10000 = this.field_1145_i;
                int n = var1 + var2 * 16;
                var10000[n] = var10000[n] + this.field_1144_j[var1 + var2 * 16] * 0.01f;
