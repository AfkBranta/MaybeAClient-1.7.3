...
public class XErrr {
    ...
    public void func_25125_a(XGuiUmmm var1) {
        ...
        this.field_25141_f += 0.1;
        if (++this.field_25138_i > this.field_25137_j) {
            this.func_25126_b();
        }
        this.field_25133_n = 2.0 - (double)this.field_25138_i / (double)this.field_25137_j * 2.0;
        if (this.field_25133_n > 1.0) {
            this.field_25133_n = 1.0;
        }
        this.field_25133_n *= this.field_25133_n;
        this.field_25133_n *= 0.5;
    }
