...
extends Thread {
    ...
    private void loadResource(File var1, String var2) {
        ...
        while (var4 < var3.length) {
            if (var3[var4].isDirectory()) {
                this.loadResource(var3[var4], String.valueOf(var2) + var3[var4].getName() + "/");
            } else {
                try {
                    this.mc.installResource(String.valueOf(var2) + var3[var4].getName(), var3[var4]);
                }
    ...
    private void downloadAndInstallResource(URL var1, String var2, long var3, int var5) {
        try {
            ...
            if (!var7.equals("sound") && !var7.equals("newsound") ? var5 != 1 : var5 != 0) {
                return;
            }
