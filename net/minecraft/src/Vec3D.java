...
public class Vec3D {
    ...
    public Vec3D subtract(Vec3D var1) {
        return Vec3D.createVector(var1.xCoord - this.xCoord, var1.yCoord - this.yCoord, var1.zCoord - this.zCoord);
    }

    public Vec3D normalize() {
        double var1 = MathHelper.sqrt_double(this.xCoord * this.xCoord + this.yCoord * this.yCoord + this.zCoord * this.zCoord);
        return var1 < 1.0E-4 ? Vec3D.createVector(0.0, 0.0, 0.0) : Vec3D.createVector(this.xCoord / var1, this.yCoord / var1, this.zCoord / var1);
    }

    public Vec3D crossProduct(Vec3D var1) {
        return Vec3D.createVector(this.yCoord * var1.zCoord - this.zCoord * var1.yCoord, this.zCoord * var1.xCoord - this.xCoord * var1.zCoord, this.xCoord * var1.yCoord - this.yCoord * var1.xCoord);
    }

    public Vec3D addVector(double var1, double var3, double var5) {
        return Vec3D.createVector(this.xCoord + var1, this.yCoord + var3, this.zCoord + var5);
    }
    ...
    public Vec3D getIntermediateWithXValue(Vec3D var1, double var2) {
        ...
        return var10 >= 0.0 && var10 <= 1.0 ? Vec3D.createVector(this.xCoord + var4 * var10, this.yCoord + var6 * var10, this.zCoord + var8 * var10) : null;
    }
