...
extends ClippingHelper {
    ...
    private void normalize(float[][] var1, int var2) {
        ...
        float[] fArray = var1[var2];
        fArray[0] = fArray[0] / var3;
        float[] fArray2 = var1[var2];
        fArray2[1] = fArray2[1] / var3;
        float[] fArray3 = var1[var2];
        fArray3[2] = fArray3[2] / var3;
        float[] fArray4 = var1[var2];
        fArray4[3] = fArray4[3] / var3;
    }
