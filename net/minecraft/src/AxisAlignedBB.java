...
public class AxisAlignedBB {
    ...
    public AxisAlignedBB addCoord(double var1, double var3, double var5) {
        ...
        return AxisAlignedBB.getBoundingBoxFromPool(var7, var9, var11, var13, var15, var17);
    }
    ...
    public AxisAlignedBB getOffsetBoundingBox(double var1, double var3, double var5) {
        return AxisAlignedBB.getBoundingBoxFromPool(this.minX + var1, this.minY + var3, this.minZ + var5, this.maxX + var1, this.maxY + var3, this.maxZ + var5);
    }
    ...
    public double calculateXOffset(AxisAlignedBB var1, double var2) {
        if (var1.maxY > this.minY && var1.minY < this.maxY) {
            if (var1.maxZ > this.minZ && var1.minZ < this.maxZ) {
                double var4;
                if (var2 > 0.0 && var1.maxX <= this.minX && (var4 = this.minX - var1.maxX) < var2) {
                    var2 = var4;
                }
                if (var2 < 0.0 && var1.minX >= this.maxX && (var4 = this.maxX - var1.minX) > var2) {
                    var2 = var4;
                }
                return var2;
            }
    ...
    public double calculateYOffset(AxisAlignedBB var1, double var2) {
        if (var1.maxX > this.minX && var1.minX < this.maxX) {
            if (var1.maxZ > this.minZ && var1.minZ < this.maxZ) {
                double var4;
                if (var2 > 0.0 && var1.maxY <= this.minY && (var4 = this.minY - var1.maxY) < var2) {
                    var2 = var4;
                }
                if (var2 < 0.0 && var1.minY >= this.maxY && (var4 = this.maxY - var1.minY) > var2) {
                    var2 = var4;
                }
                return var2;
            }
    ...
    public double calculateZOffset(AxisAlignedBB var1, double var2) {
        if (var1.maxX > this.minX && var1.minX < this.maxX) {
            if (var1.maxY > this.minY && var1.minY < this.maxY) {
                double var4;
                if (var2 > 0.0 && var1.maxZ <= this.minZ && (var4 = this.minZ - var1.maxZ) < var2) {
                    var2 = var4;
                }
                if (var2 < 0.0 && var1.minZ >= this.maxZ && (var4 = this.maxZ - var1.minZ) > var2) {
                    var2 = var4;
                }
                return var2;
            }
