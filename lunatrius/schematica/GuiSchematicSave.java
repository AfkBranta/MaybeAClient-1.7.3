...
extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton guiButton) {
        if (guiButton.enabled) {
            if (guiButton.id == this.btnPointA.id) {
                ...
                String path = new File(Settings.schematicDirectory, String.valueOf(this.tfFilename.getText()) + ".schematic").getAbsolutePath();
    ...
    public void drawScreen(int par1, int par2, float par3) {
        this.drawString(this.fontRenderer, "Save the selection as a schematic", this.width - 205, this.height - 45, 0xFFFFFF);
        this.drawString(this.fontRenderer, "X", this.centerX - 145, this.centerY - 24, 0xFFFFFF);
        this.drawString(this.fontRenderer, Integer.toString(this.settings.pointA.x), this.centerX - 25, this.centerY - 24, 0xFFFFFF);
        this.drawString(this.fontRenderer, "Y", this.centerX - 145, this.centerY + 1, 0xFFFFFF);
        this.drawString(this.fontRenderer, Integer.toString(this.settings.pointA.y), this.centerX - 25, this.centerY + 1, 0xFFFFFF);
        this.drawString(this.fontRenderer, "Z", this.centerX - 145, this.centerY + 26, 0xFFFFFF);
        this.drawString(this.fontRenderer, Integer.toString(this.settings.pointA.z), this.centerX - 25, this.centerY + 26, 0xFFFFFF);
        this.drawString(this.fontRenderer, "X", this.centerX + 15, this.centerY - 24, 0xFFFFFF);
        this.drawString(this.fontRenderer, Integer.toString(this.settings.pointB.x), this.centerX + 135, this.centerY - 24, 0xFFFFFF);
        this.drawString(this.fontRenderer, "Y", this.centerX + 15, this.centerY + 1, 0xFFFFFF);
        this.drawString(this.fontRenderer, Integer.toString(this.settings.pointB.y), this.centerX + 135, this.centerY + 1, 0xFFFFFF);
        this.drawString(this.fontRenderer, "Z", this.centerX + 15, this.centerY + 26, 0xFFFFFF);
        this.drawString(this.fontRenderer, Integer.toString(this.settings.pointB.z), this.centerX + 135, this.centerY + 26, 0xFFFFFF);
