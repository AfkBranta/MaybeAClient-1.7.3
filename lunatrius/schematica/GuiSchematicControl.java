...
extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton guiButton) {
        if (guiButton.enabled) {
            if (guiButton.id == this.btnDecX.id) {
                ...
                this.settings.renderingLayer = this.settings.schematic != null ? GuiSchematicControl.clamp_int(this.settings.renderingLayer - 1, -1, this.settings.schematic.height() - 1) : -1;
    ...
    public void drawScreen(int par1, int par2, float par3) {
        this.drawCenteredString(this.fontRenderer, this.strTranslate.translateKey("schematic.moveschematic"), this.centerX, this.centerY - 45, 0xFFFFFF);
        this.drawCenteredString(this.fontRenderer, this.strTranslate.translateKey("schematic.layers"), this.width - 50, this.height - 165, 0xFFFFFF);
        this.drawCenteredString(this.fontRenderer, this.strTranslate.translateKey("schematic.operations"), this.width - 50, this.height - 120, 0xFFFFFF);
        this.drawCenteredString(this.fontRenderer, this.settings.renderingLayer < 0 ? this.strTranslate.translateKey("schematic.all") : Integer.toString(this.settings.renderingLayer + 1), this.width - 50, this.height - 145, 0xFFFFFF);
        this.drawString(this.fontRenderer, this.strTranslate.translateKey("schematic.x"), this.centerX - 65, this.centerY - 24, 0xFFFFFF);
        this.drawString(this.fontRenderer, Integer.toString(this.settings.offset.x), this.centerX + 55, this.centerY - 24, 0xFFFFFF);
        this.drawString(this.fontRenderer, this.strTranslate.translateKey("schematic.y"), this.centerX - 65, this.centerY + 1, 0xFFFFFF);
        this.drawString(this.fontRenderer, Integer.toString(this.settings.offset.y), this.centerX + 55, this.centerY + 1, 0xFFFFFF);
        this.drawString(this.fontRenderer, this.strTranslate.translateKey("schematic.z"), this.centerX - 65, this.centerY + 26, 0xFFFFFF);
        this.drawString(this.fontRenderer, Integer.toString(this.settings.offset.z), this.centerX + 55, this.centerY + 26, 0xFFFFFF);
